...
class InsightEngine:
    ...
    def assess(
        ...
        narrative = self._narrative(identifiers, accounts, exposure, risk, coverage)
    ...
    # ---------------------------------------------------------------- narrative
    def _narrative(self, identifiers, accounts, exposure, risk, coverage) -> str:
        ids = []
        ...
        parts.append(
            f"Overall exposure is assessed {risk['band']} ({risk['score']}/100). "
